...
require_once( CONTRACTOR_DIRECTORY_PLUGIN_DIR . 'lib/bl/bl-functions.php' );
...
if( is_admin() ) {
    ...
    if( !class_exists( 'dBug' ) ) 
        require_once( CONTRACTOR_DIRECTORY_PLUGIN_DIR . 'lib/bl/dBug.php' );

    /*
    * Local extension to debug bar
    */
    require_once( CONTRACTOR_DIRECTORY_PLUGIN_DIR . 'lib/bl/BLDebugBar.class.php' );
}
...
*/
require_once( CONTRACTOR_DIRECTORY_PLUGIN_DIR . 'lib/functions.php' );